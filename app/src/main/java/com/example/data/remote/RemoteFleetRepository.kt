...
class RemoteFleetRepository(private val api: ApiService) {
    ...
    suspend fun login(
        ...
        try {
            ...
            if (response.isSuccessful && response.body()?.success == true) {
                ...
                Result.failure(
                    Exception(response.body()?.message ?: "خطا در ورود")
                )
            }
        } catch (e: Exception) {
    ...
    suspend fun loadDrivers(search: String? = null): Result<List<Driver>> =
    ...
    suspend fun getDriverDetail(id: String): Result<DriverDetail> =
        withContext(Dispatchers.IO) {
            try {
    ...
    suspend fun registerTrip(
        ...
        try {
            ...
            if (response.isSuccessful && response.body()?.success == true) {
                ...
                Result.failure(
                    Exception(
                        response.body()?.message ?: "خطا در ثبت سفر"
                    )
                )
            }
        } catch (e: Exception) {
        ...
        withContext(Dispatchers.IO) {
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    Result.failure(
                        Exception(
                            response.body()?.message ?: "خطا در حذف سفر"
                        )
                    )
                }
            } catch (e: Exception) {
    ...
    suspend fun submitDailyWork(
        ...
        try {
            ...
            if (response.isSuccessful) {
                ...
                Result.failure(
                    Exception(
                        response.body()?.message ?: "خطا در ارسال کارکرد"
                    )
                )
            }
        } catch (e: Exception) {
    ...
    suspend fun loadAllDailyWorkApprovals():
        Result<List<PendingDailyApproval>> = withContext(Dispatchers.IO) {
    ...
    suspend fun approveDailyWork(
        ...
        try {
            ...
            if (response.isSuccessful) {
                ...
                Result.failure(
                    Exception(
                        response.body()?.message ?: "خطا در تأیید"
                    )
                )
            }
        } catch (e: Exception) {
    ...
    suspend fun rejectDailyWork(
        ...
        try {
            ...
            if (response.isSuccessful) {
                ...
                Result.failure(
                    Exception(
                        response.body()?.message ?: "خطا در رد"
                    )
                )
            }
        } catch (e: Exception) {
    ...
    suspend fun unlockDailyWork(
        ...
        try {
            ...
            if (response.isSuccessful) {
                ...
                Result.failure(
                    Exception(
                        response.body()?.message ?: "خطا در بازگشایی"
                    )
                )
            }
        } catch (e: Exception) {
    ...
    suspend fun saveDriver(
        ...
        try {
            ...
            if (response.isSuccessful && response.body()?.success == true) {
                ...
                Result.failure(
                    Exception(
                        response.body()?.message ?: "خطا در ذخیره راننده"
                    )
                )
            }
        } catch (e: Exception) {
    ...
    suspend fun toggleDriverStatus(
        ...
        try {
            ...
            if (response.isSuccessful) {
                ...
                Result.failure(Exception("خطا در تغییر وضعیت"))
            }
        } catch (e: Exception) {
            Result.failure(Exception("ارتباط با سرور برقرار نیست"))
        }
